...
<div class="App">
	...
	<div class="ui inverted top fixed menu" style:"width:90%">
		...
		<a class="header item" href="http://dmac.pharmacy.arizona.edu/Hera/Home">
		<h1 >Hera</h1>
		</a>
			...
			<div class="ui float right dropdown link item">
   		 		<span class="text">Menu</span>
    					<div class="menu">    
      						...
      						<a class="item" href="http://dmac.pharmacy.arizona.edu/Hera/Home"> Geo Up </a>
...
cat('
	...
	<form enctype="multipart/form-data" method="POST" action="https://dmac.pharmacy.arizona.edu/Hera/Home">
...
cat('<i class="exclamation triangle icon"></i> Error Reading Site Name')
	...
	cat(df_site$name)
		...
		Depths: ')
		cat("0-5, 5-15, 15-25, 25-35, 35-38, 38-54, 180-183")
